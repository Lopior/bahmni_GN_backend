...
#  acceder a las variables usando os.environ
host = os.environ.get("OPENMMRS_MYSQL_HOST")
bd_notificacion = os.environ.get("NOTIFICACIONES_DATABASE")
username = os.environ.get("MYSQL_USER_NOTIFICACIONES")
password = os.environ.get("MYSQL_PASSWORD_NOTIFICACIONES")
